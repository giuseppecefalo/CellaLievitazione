 ...
 *      DEFINES
 *********************/
#define LV_FONT_MONTSERRAT_8 1  // Deve essere 1 per abilitare il font
#define LV_FONT_MONTSERRAT_10 1  // Deve essere 1 per abilitare il font
#define LV_FONT_MONTSERRAT_12 1  // Deve essere 1 per abilitare il font
#define LV_FONT_MONTSERRAT_14 1  // Deve essere 1 per abilitare il font
#define LV_FONT_DEJAVUSANS_10 1
